...
\begin{frame}{Result 4: Simulation Physics Gap (100\% vs.\ 97.4\% Success)}
    \small
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
...
\begin{frame}{GitHub Link and Individual Contribution}
    \vspace{-6pt}
    \centering
    {\small \textbf{Repository:} \href{https://github.com/Farhan41229/Drl-unsignalized-intersection-navigation}{\textcolor{accentblue}{\texttt{https://github.com/Farhan41229/Drl-unsignalized-intersection-navigation}}}}\\[6pt]
    \begin{columns}[c]
        \begin{column}{0.56\textwidth}
            \centering
            \includegraphics[width=\linewidth]{img/github_contributions.png}
        \end{column}
        \begin{column}{0.42\textwidth}
            \footnotesize
            \textbf{Ishmam Tahmid} \scriptsize(220041259)\\[1pt]
            {\tiny \textcolor{accentblue}{\texttt{@ishmam259}} $\cdot$ 16 commits (+3.8k / -250)}\\
            {\scriptsize $\blacktriangleright$ Auto-tuned $\alpha$, eval engine, telemetry}\\[8pt]

            \footnotesize
            \textbf{Mahmudul Hasan} \scriptsize(220041231)\\[1pt]
            {\tiny \textcolor{accentblue}{\texttt{@beiged-kybou}} $\cdot$ 14 commits (+788 / -200)}\\
            {\scriptsize $\blacktriangleright$ Discrete SAC core, buffer, intent $\mu_a$}\\[8pt]

            \footnotesize
            \textbf{Farhan Tahsin Khan} \scriptsize(220041229)\\[1pt]
            {\tiny \textcolor{accentblue}{\texttt{@Farhan41229}} $\cdot$ 13 commits (+1.6k / -100)}\\
            {\scriptsize $\blacktriangleright$ Sim infra, P-core pinning, pipelines}
        \end{column}
    \end{columns}
\end{frame}
